...
#define CPortal_Player C_BasePortalPlayer
#else
...
// Purpose: 
//-----------------------------------------------------------------------------
inline CPortal_Player	*CHL2GameMovement::GetHL2Player()
{
...
inline void CHL2GameMovement::SetLadder( CFuncLadder *ladder )
{
	...
	GetHL2Player()->m_PortalLocal.m_hLadder.Set( ladder );
}
...
{
	return static_cast<CFuncLadder*>( static_cast<CBaseEntity *>( GetHL2Player()->m_PortalLocal.m_hLadder.Get() ) );
}
